...
// Ship bitmap function converts a ship kind into a bitmap that can be used.
...
player_data new_player()
{
    ...
    // Position in the center of the initial screen
    ...
    // Setting the camera at 0 position every time a new player is created
    set_camera_x(0);
    set_camera_y(0);
...
void update_player(player_data &player_to_update)
{
    ...
    // Decrease the fuel and health of the player with the game going on
