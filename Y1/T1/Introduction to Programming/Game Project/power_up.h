...
/**
 * The power_up_data struct keeps track of all information related to the power-up.
 *
...
/**
 * Creates a new power-up at the specified position on the screen with a random power-up kind.
 *
 ...
 *
 * @param power_to_draw The power-up to draw on the screen
 */
